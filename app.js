...
const CHANGELOG = {
  ...
  'v3.1.2': {
    date: 'Haziran 2026',
    items: [
      '[Düzeltildi] Ok tuşu navigasyonu: satır ve tablo sınırında durur, önceki satıra atlamaz',
      '[Düzeltildi] Hücre editörü scroll sırasında kayıyor ve viewport dışına taşıyordu',
      '[İyileştirildi] Sağ/aşağı ok sınırında toplam kolonları ve Genel Toplam görünür hale gelir',
    ]
  },
  'v3.1.1': {
    date: 'Haziran 2026',
    items: [
      '[İyileştirildi] Hedefler filtre menüleri artık yalnızca mevcut filtreyle eşleşen değerleri gösteriyor',
    ]
  },
  'v3.1.0': {
    date: 'Haziran 2026',
  ...
  'v2.3.0': {
    date: 'Haziran 2026',
    items: [
      '[Eklendi] Tablo hücrelerinde ok tuşları ve Enter ile gezinme.',
      '[Düzeltildi] Müşteri seçilince siparişsiz mod otomatik açılıyor.',
      '[Düzeltildi] Ülkeler customer_countries tablosundan geliyor.',
    ]
  },
  'v2.2.0': {
    date: 'Haziran 2026',
    items: [
      '[Düzeltildi] İndir menüsü doğru konumda açılıyor.',
    ]
  },
  'v2.1.0': {
    date: 'Haziran 2026',
